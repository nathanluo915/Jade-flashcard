...
Deck.create(name: "Starwars")

Card.create([{question: "Elephants can reach their tails by their noes.", answer: "false", deck_id: 1},
...
Card.create([{question: "To create a second name for the variable or method.", answer: "alias", deck_id: 2},
             ...
             {question: "Opens a class definition block, which can later be reopened and added to with variables and even functions.", answer: "class", deck_id: 2}             {question: "Used to define a function.", answer: "def", deck_id: 2},
